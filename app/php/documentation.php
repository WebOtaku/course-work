            ...
            <div class="header_top">
                ...
                <nav class="main_nav">
                    <ul>
                        ...
                        <li class="main_nav__link link-yellow" title="active"><a href="../php/documentation.php">Документация</a></li>
                        ...
                        <li class="main_nav__link link-red"><a href="../php/authorization_form.php">Войти</a></li>
                    </ul>
                </nav>
            </div>
